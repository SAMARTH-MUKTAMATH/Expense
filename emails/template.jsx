...
export default function EmailTemplate({
  ...
  if (type === "monthly-report") {
    ...
    return (
      <Html>
        <Head />
        <Preview>Your monthly BudgetFLOW report is here</Preview>
        <Body style={styles.body}>
          <Container style={styles.container}>
            <Heading style={styles.title}>Your monthly report</Heading>
            <Text style={styles.text}>Hi {userName},</Text>
            <Text style={styles.text}>
              Here&rsquo;s your BudgetFLOW summary for {data?.month}.
            </Text>
            ...
            {data?.insights && (
              <Section style={styles.section}>
                <Heading style={styles.heading}>BudgetFLOW insights</Heading>
            ...
            <Text style={styles.footer}>
              Thanks for using BudgetFLOW. Keep tracking — every rupee counts.
            </Text>
          </Container>
        </Body>
      </Html>
  ...
  if (type === "budget-alert") {
    ...
    return (
      <Html>
        <Head />
        <Preview>Budget alert from BudgetFLOW</Preview>
        <Body style={styles.body}>
          <Container style={styles.container}>
            ...
            <Text style={styles.footer}>
              Open your BudgetFLOW dashboard to see what&rsquo;s driving the spend.
            </Text>
          </Container>
        </Body>
      </Html>
